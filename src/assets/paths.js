module.exports.paths = {
  "villeneuve-les-maguelone": {
    ...
    "start": "Place de l’Église, en direction de l’avenue du Chapitre, au-dessus du Square Berthès",
  ...
  "murviel-les-montpellier": {
    ...
    "start": "Devant la fontaine romaine, en contrebas de la Route de Bel Air",
  ...
  "clapiers": {
    ...
    "start": "Près du parking du Collège François Mitterrand au début du chemin des écoliers parallèle à l’Avenue Georges Frêche",
  ...
  "saintgeorges": {
    ...
    "start": "au dos du panneau indiquant la sortie de Saint Georges d’Orques, sur la Route de Pignan (D5E5)",
  ...
  "restinclieres": {
    ...
    "start": "Sur la rambarde de la passerelle permanente au début du Chemin du Château, le long de la D610.",
